			...
			<div class="row align-items-center justify-content-between">
				<div class="col-12 col-md-8">
					<ul class="nav">
						...
						<li class="nav-item"><a href="#" class="nav-link">item-categoria</a></li>
						<li class="nav-item"><a href="#" class="nav-link">item-categoria</a></li>
						<li class="nav-item"><a href="#" class="nav-link">item-categoria</a></li>
						<li class="nav-item"><a href="#" class="nav-link">item-categoria</a></li>
					</ul>
		...
		<div class="container">
			<div class="row">
				...
				<aside class="col-12 col-md-4 sidebar">
					<h3>Newsletter</h3>
					<p>Suscríbete a nuestra Newslleter y recibe las últimas noticias</p>
					<form action="" class="form_contact">
						...
						<div class="text-center">
							<input type="submit" class="btn btn-secondary" value="SUSCRIBIRME">
						</div>
					</form>
					...
					<h3>Noticias</h3>
					<div class="spaced_2"></div>
					<div class="media">
					  <img class="mr-3" src="img/blog/image-6.jpeg" alt="Generic placeholder image">
					  <div class="media-body">
					    <a href="#" class="color_green"><h5 class="mt-0">Título del blog</h5></a>
					    <div class="datetime">May 24 2018</div>
					  </div>
					</div>
					<div class="spaced_2"></div>
					<div class="media">
